...
export const ApproveBudgetAndFund = (props: Props) => {
  ...
  const waitForSufficientFunds = (
    <Flex alignItems="left" flexDirection="column">
      ...
      <Text pb={3} fontSize={1}>
        You don&#39;t have enough TFILin your wallet!
      </Text>
      <Text pb={3} fontSize={1}>
        You&#39;ll need at least {formatEther(BN.from(playerAmount))} TFILin your Metamask wallet to
  ...
  const waitForUserApproval = ({ waiting }: { waiting: boolean } = { waiting: false }) => (
    <Flex alignItems="left" flexDirection="column">
      ...
      <Text pb={3} fontSize={1}>
        You will deposit {formatEther(BN.from(playerAmount))} TFILinto a channel. Our hub will also
        make a deposit.
